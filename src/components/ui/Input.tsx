         ...
         render={(field) => (
            <div class={local.wrapperClass}>
               ...
               >
                  ...
                  <input
                     class={`w-full px-3  py-3 text-slate-800 bg-white/50 focus:bg-white/50 hover:bg-slate-300 placeholder-slate-500 outline-none text-base font-light rounded-xl`}
