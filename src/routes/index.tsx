...
export default function Home() {
   return (
      <>
         <Title>Story Garden | Write and Organise Your Stories</Title>
         <Meta
            name="description"
            content="Story Garden is the perfect platform for authors who want to write, organize, and structure their stories."
         />
